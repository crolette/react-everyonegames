...
export default function GamePage() {
	...
	// 		`https://api.rawg.io/api/games/${gameId}?key=ba9593ab19304984b0939ad8790ad96e`
	// 	);
				...
				<section className='game__header'>
					...
					<div className='header__subtitles'>
						<p className='header__playtime'>
							Average playtime: {data.playtime}h
						</p>
						<p className='header__rating'>Rating: {data.rating}</p>
					</div>
				</section>
